...
@section('content')
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Cours</h2>
            </div>
            <div class="flex flex-wrap items-center">
                <a href="{{ route('subject.create') }}" class="bg-gray-200 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
                    ...
                    <span class="ml-2 text-xs font-semibold">Cours</span>
                </a>
            </div>
        </div>
        ...
        <thead class="justify-between">
          <tr class="bg-gray-800">
            <th style="text-align: left; padding-left:15px;" class="py-2">
              <span class="text-gray-300">Libellé</span>
            </th>
            <th style="text-align: left; padding-left:15px;" class="py-2">
              <span class="text-gray-300">Code</span>
            </th>
            <th style="text-align: left; padding-left:15px;" class="py-2">
              <span class="text-gray-300">Professeur</span>
            </th>
          ...
          <tr class="bg-white border-4 border-gray-200">
            <td>
              <span class="text-center ml-2 font-semibold">{{ $subject->name }}</span>
            </td>
            <td class="py-2">
